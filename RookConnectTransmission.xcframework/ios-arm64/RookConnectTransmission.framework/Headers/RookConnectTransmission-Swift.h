...
- (nonnull instancetype)initWithCaloriesNetIntakeKilocalories:(NSInteger)caloriesNetIntakeKilocalories caloriesExpenditureKilocalories:(float)caloriesExpenditureKilocalories caloriesNetActiveKilocalories:(float)caloriesNetActiveKilocalories caloriesBasalMetabolicRateKilocalories:(float)caloriesBasalMetabolicRateKilocalories fatPercentageOfCaloriesPercentage:(NSInteger)fatPercentageOfCaloriesPercentage carbohydratePercentageOfCaloriesPercentage:(NSInteger)carbohydratePercentageOfCaloriesPercentage proteinPercentageOfCaloriesPercentage:(NSInteger)proteinPercentageOfCaloriesPercentage OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
